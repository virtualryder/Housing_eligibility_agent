...
> validated release tag [`v0.9.6`](https://github.com/virtualryder/Housing_eligibility_agent/releases/tag/v0.9.6)**
...
```bash
git checkout v0.9.6                      # deploy a VALIDATED RELEASE TAG, never main
