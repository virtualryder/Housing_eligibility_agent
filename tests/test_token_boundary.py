...
def test_inject_only_for_signoff_and_overrides_model_token():
    ...
    a = token_boundary.prepare_args("assess-eligibility___assess_housing_eligibility",
...
def test_wrap_intercepts_positional_and_keyword_calls():
    ...
    c.call_tool_sync("t2", name="hou-core___draft_notice", arguments={"case": "x", "token": "stolen"})
