...
Current validated release: **[`v0.11.0`](https://github.com/virtualryder/Housing_eligibility_agent/releases/tag/v0.11.0)**
...
security metrics): **complete, live-validated (2026-07-24 run, governed-core 1.1.0 <!-- count-gate:historical --> era).** The supported tag `v0.11.0` pins governed-core 1.10.1 <!-- count-gate:historical --> — main has since moved to 1.11.1 — **offline-gated only** — no AgentCore-era live gate has run on this pack yet (see README "Currency note"). Remaining before real applicant PII: a Housing live re-gate on 1.11.1, then **customer-side
