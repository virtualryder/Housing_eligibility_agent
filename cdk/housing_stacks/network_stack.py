...
external destination is the HUD USER API (the pipeline's single sanctioned external dependency).
...
class NetworkStack(cdk.Stack):
    def __init__(self, scope: Construct, cid: str, *, prefix: str, **kw):
        ...
        rule_group = nfw.CfnRuleGroup(
            ...
            description="Gate-B locked egress: HUD USER API is the ONLY sanctioned external destination")
