...
# limits used by assess_housing_eligibility and returns PROVENANCE so the determination and the WORM
# audit are traceable to the source (parallel to lookup_coa/College Scorecard in the EDU agent).
#
...
# when the token is absent or the county is unknown.
...
def handler(event, context):
    ...
    return {
        ...
        "note": "authoritative HUD income limits; pass il30/il50/il80 and il_source to assess_housing_eligibility",
    }
