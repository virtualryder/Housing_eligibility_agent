...
(() => {
  ...
  const stats = [["189/189", "automated tests green", MINT], ["3", "clean-account live validation runs captured", TEAL], ["10", "real defects found & fixed by validation", AMBER], ["0", "residual on teardown", NAVY]];
