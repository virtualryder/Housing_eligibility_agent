...
const body = [
  ...
  H2("0.1 Deploy"),
  codeBlock([
    "git checkout v0.11.0        # a validated release tag, never main",
...
Packer.toBuffer(doc).then((b) => { require("fs").writeFileSync(require("path").join(__dirname, "..", "Housing-AgentCore-SA-Runbook.docx"), b); console.log("wrote runbook"); });
