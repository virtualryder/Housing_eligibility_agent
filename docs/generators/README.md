# Doc generators — Housing AgentCore
...
|---|---|
| `runbook.js` | `Housing-AgentCore-SA-Runbook.docx` |
| `maintenance.js` | `Housing-AgentCore-Maintenance.docx` |
| `regulatory.js` | `Housing-AgentCore-Regulatory-Adherence.docx` |
| `leadership_deck.js` | `Housing-AgentCore-Leadership.pptx` |
| `customer_deck.js` | `Housing-AgentCore-Customer.pptx` |
...
node generators/runbook.js             # -> docs/Housing-AgentCore-SA-Runbook.docx
node generators/maintenance.js
node generators/regulatory.js
node generators/leadership_deck.js     # -> docs/Housing-AgentCore-Leadership.pptx
