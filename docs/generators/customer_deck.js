...
(() => {
  ...
  const stats = [["208/208", "automated tests green in CI", MINT], ["End-to-end", "proven live - including fully network-isolated", TEAL], ["100%", "of determinations gated by a specialist", AMBER]];
